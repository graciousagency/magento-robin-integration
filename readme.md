Magento -> Robin. Get the info you need!
==========================================================
...
Make sure you have your Robin API key and API secret. If you don't have the API secret, [You can request it here][request-api-key-secret]. You can also ask them what your API key is if you don't know where to find it.
